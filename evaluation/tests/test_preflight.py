...
def test_offline_preflight_fails_after_dataset_tampering(tmp_path: Path) -> None:
    ...
    assert summary.errors == ["synthetic-solid-blue-001: image SHA-256 mismatch"]
