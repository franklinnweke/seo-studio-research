...
- [ ] Complete project-author visual review and final 1280px materialization/validation of the assembled 128-image licensed candidate set, balanced 32 per domain; record same-stratum replacements additively.
