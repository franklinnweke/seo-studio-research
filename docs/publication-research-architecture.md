...
- [ ] Decide whether to authorize a project-isolated newer Ollama runtime/model store for the Gemma 4 amendment or document Gemma 4 as incompatible with the deployed Ollama 0.24.0 stack.
