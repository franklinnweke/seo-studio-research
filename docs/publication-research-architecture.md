...
- Latest completed research commit before the finalized writer evidence: `8a2701d` (`Add deterministic writer compatibility pass`).
...
- The full 20-item compatibility matrix and fixed-writer compatibility pass are complete with sanitized evidence under `evaluation/results/`; candidate amendment, protocol freeze, the approximately 120-item final dataset, full experiments, human annotation, statistical analysis, and the manuscript remain outstanding.
...
- A5 evidence explicitly forbids quality ranking from the one-image smoke, completed five-condition compatibility matrix, and five-call writer pass. The candidate amendment still remains before Gate 3 can close.
...
- [ ] Approve a candidate amendment and qualify at least one additional challenger without lowering the frozen 95% gate.
